...
namespace NewsManagementDotNetCoreApp.Controllers
{
    ...
    public class CategoriesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,Name,CatPlace")] Category category)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Name,CatPlace")] Category category)
        {
            if (id != category.ID)
            {
                return NotFound();
